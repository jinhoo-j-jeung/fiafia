...
import { contains, getUsers } from '../src/api/GetUsers';

/**
 * A first/default tab in the top tab in the search screen.
 * It has a search bar in which the user can search for a specific user.
 */
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <ListItem
                                ...
                                onPress={() => this.props.navigation.navigate('SearchUserDetail', {
