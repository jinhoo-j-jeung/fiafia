...
/**
 * A friend screen that renders a list of users who sent a friend request to the logged-in user.
 * It also has a search bar in which the user can search for a specific user.
 */
export default class FriendReceivedScreen extends Component {
